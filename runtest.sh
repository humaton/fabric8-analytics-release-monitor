...
IMAGE_NAME=${IMAGE_NAME:-quay.io/fabric8-analytics/f8a-api-gateway}
...
DISABLE_AUTHENTICATION=1 PYTHONDONTWRITEBYTECODE=1 python3 `which pytest` --cov=. --cov-report term-missing -vv tests
